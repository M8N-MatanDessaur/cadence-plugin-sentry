# Sentry Error Tracker -- Cadence Plugin
...
1. Copy this folder to `dashboard/plugins/sentry/` in your Cadence installation
2. Open Cadence and go to **Settings > Plugins**
3. Configure:
