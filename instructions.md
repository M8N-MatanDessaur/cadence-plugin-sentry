...
You have access to a Sentry error tracking plugin via the Cadence API. This lets you monitor application errors, view stack traces, analyze error trends, and create Azure DevOps work items from Sentry issues.
...
- Creating work items calls the Cadence API internally -- the work item appears in Azure DevOps
